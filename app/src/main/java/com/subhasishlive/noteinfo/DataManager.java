...
public class DataManager {
    ...
    // The following List of type NoteInfo will contains all the notes that we will take...
    private List<NoteInfo> mNotes = new ArrayList<>();

    // static method that has the return type object of DataManager class.
    // This method will be useful while creating new instance of DataManager class...
    ...
    public int createNewNote() {
        // creating new instance of NoteInfo class
        NoteInfo note = new NoteInfo(null, null, null);
        // create that instance as item to mNotes list.
        mNotes.add(note);
        // return the size of mNotes.
    ...
    public int createNewNote(CourseInfo course, String noteTitle, String noteText) {
        ...
        // now getting the note in that index
        NoteInfo note = getNotes().get(index);
        // setting the course, title, text for that note
